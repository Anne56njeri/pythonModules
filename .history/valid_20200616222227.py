...
def valid(str):
    ...
    if len(address) == 4:
        ...
        while i < len(newAddress)-1:
            ...
            if newAddress[i] == "":
                return "Neither"
            if len(newAddress[i]) == 4 and newAddress[i].count("0") == "0" and newAddress[i][1] == "0" and newAddress[i][2] == "0" and newAddress[i][3] == "0":
                print("here")
...
# "12..33.4"
# "172.16.254.1"
print(valid("2001:0db8:85a3:0:0:8A2E:0370:7334"))